...
formula_dict = data_reader.get_collection_treesif()
def flat(l):
    for k in l:
...
print(formula_dict)
# python3 tangent_cft_front_end.py -cid 1 --t 0 --r 1 -ds 'NTCIR-12_MathIR_Wikipedia_Corpus/MathTagArticles' --qd 'query_file' --slt 0 -em 'opt_sif.csv' --mp 'Models/treesif_model' --rf res_12_02_opt_sif
